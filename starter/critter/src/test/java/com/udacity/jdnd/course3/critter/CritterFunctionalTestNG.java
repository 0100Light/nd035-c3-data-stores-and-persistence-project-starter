...
//    CustomerService customerService;
    ...
    public void testCreateCustomer(){
        ...
        Assert.assertEquals(newCustomer.getId(), retrievedCustomer.getId());
        Assert.assertTrue(retrievedCustomer.getId() > 0);
    }
    ...
    public void testAddPetsToCustomer() {
        ...
        Assert.assertEquals(retrievedPet.getId(), newPet.getId());
        Assert.assertEquals(retrievedPet.getOwnerId(), newCustomer.getId());
    ...
    public void testFindPetsByOwner() {
        ...
        Assert.assertEquals(pets.get(0).getOwnerId(), newCustomer.getId());
        Assert.assertEquals(pets.get(0).getId(), newPet.getId());
    }
